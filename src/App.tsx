...
export default function App() {
  ...
  // ── Unified App Layout ──────────────────────────────────────────
  return (
    <div className={`min-h-[100dvh] bg-[#0A0A0F] font-['Plus_Jakarta_Sans',sans-serif] relative overflow-hidden flex flex-col pt-safe pb-safe ${currentTrip ? "font-['Space_Grotesk',sans-serif]" : ""}`}>
